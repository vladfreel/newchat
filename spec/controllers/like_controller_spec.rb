...
RSpec.describe LikesController, :type => :controller do
  ...
  describe 'DELETE destroy' do
    it 'deletes the category' do
      ...
      expect{delete :destroy, params: {category_id: @category.id ,image_id: @image.id ,id: like.id} }.to change(Like,:count).by(-1)
    ...
    it 'redirects to categories#index' do
      ...
      response.should redirect_to category_image_path(@category.id, @image.id)
      expect(response).to have_http_status(302)
    end
  end
end
