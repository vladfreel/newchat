...
describe 'add category' do
  ...
  it 'check comment' do
    ...
    expect(current_path) == '/ru/admin/user_comments'
  ...
  it 'check like' do
    click_on('Лайк')
    expect(current_path) == '/ru/admin/likes'
  ...
  it 'check events' do
    click_on('Events')
    expect(current_path) == '/ru/admin/events'
  ...
  it 'check categories' do
    click_on('Категория')
    expect(current_path) == '/ru/admin/categories'
  ...
  it 'check images' do
    click_on('Картинка')
    expect(current_path) == '/ru/admin/images'
